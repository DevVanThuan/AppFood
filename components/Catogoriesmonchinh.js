import { View, Text, FlatList, StyleSheet, Touchable, Image } from 'react-native'
import React from 'react'
import { FontAwesome, FontAwesome6 } from '@expo/vector-icons';
import { MONCHINH } from '../app/FoodImage/FoodData';
import { TouchableOpacity } from 'react-native';

export default function Catogoriesmonchinh() {
    const ngoisao = [];
    for (let i = 0; i < 5; i++) {
        ngoisao.push(
            <FontAwesome
    ...
    return (<View>
        <Text style={{marginLeft:10, fontWeight:'bold', fontSize:20}}>Món Chính</Text>
